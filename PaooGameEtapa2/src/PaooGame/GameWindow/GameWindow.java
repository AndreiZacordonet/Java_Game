...
//    private final int wndWidth = tileSize * maxScreenCol;        //1024
//    private final int wndHeight = tileSize * maxScreenRow;       //768
    ...
    public void BuildGameWindow()
    {
        ...
        wndFrame.setResizable(false);    //default = false
        ...
        canvas.setBackground(Color.BLACK);  //background
